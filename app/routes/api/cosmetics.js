    ...
    app.get('/api/cosmetics', (req, res) => {
        ...
        database.query("SELECT * FROM `cosmetics` ", function (err, rows, fields) {
            ...
            for (var i = 0; i < rows.length; i++) {
                ...
                var foreheadBand = new Object();

                foreheadBand.enabled = row.foreheadBand_enabled
                foreheadBand.r = row.foreheadBand_r
                foreheadBand.g = row.foreheadBand_g
                foreheadBand.b = row.foreheadBand_b
